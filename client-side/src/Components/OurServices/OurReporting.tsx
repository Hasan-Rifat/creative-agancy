...
type OurReportingProps = {};

const OurReporting: React.FC<OurReportingProps> = () => {
  type services = {
    id: number;
    title: string;
    description: string;
  ...
  return (
    <Layout className="xss:py-[50px] md:py-[120px] xss:px-[20px] md:px-[50px] bg-white">
      <div>
        <div>
          <div>
